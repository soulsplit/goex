...
[English](https://github.com/soulsplit/goex/blob/dev/README_en.md)

### wiki文档

[文档](https://github.com/soulsplit/goex/wiki)
...
``` go get github.com/soulsplit/goex ```

>建议go mod 管理依赖
``` 
require (
          github.com/soulsplit/goex latest
)
```
